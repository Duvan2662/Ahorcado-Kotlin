...
import com.example.ahorcado.databinding.ActivityDosBinding
...
class Dos : AppCompatActivity() {
    ...
    private fun Tiempo(){
        ...
        countDownTimer = object : CountDownTimer(180000, 1000) {
            ...
            override fun onFinish() {
                ...
                val builder = AlertDialog.Builder(this@Dos)
    ...
    private fun Tematica():String{
        val tematica = arrayOf("Animales","Ciudades","Deportes","Frutas")
    ...
    private fun RandomPalabra(tematica:String):String{
        val frutas= arrayOf("MANZANA", "NARANJA", "PLATANO", "KIWI", "PERA", "FRESA", "MANGO", "SANDIA", "MELON", "UVA")
        val animales = arrayOf("LEON", "TIGRE", "OSO", "LOBO", "JIRAFA", "ELEFANTE", "RINOCERONTE", "HIPOPOTAMO", "COCODRILO", "SERPIENTE")
        val ciudades = arrayOf("BOGOTA", "MEDELLIN", "CALI", "BARRANQUILLA", "CARTAGENA", "BUCARAMANGA", "CUCUTA", "IBAGUE", "PASTO", "MANIZALES")
        val deportes = arrayOf("FUTBOL", "BASQUETBOL", "TENIS", "VOLEY", "ATLETISMO", "GIMNASIA", "BOXEO", "NATACION", "CICLISMO", "GOLF")
    ...
    fun Ganador(){
        var intent = Intent(this, Ganador2::class.java)
